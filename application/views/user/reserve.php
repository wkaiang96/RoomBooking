<div class="container-fluid" style="margin-top:8%; margin-bottom:5%; text-align:left">
	...
	<div class="col-md-6">
		<table style="width:100%">
			<tr>
				<td>
					<img src="http://localhost/roomBooking/bookingSystem/img/event1.png" alt="room" width="480px" height="250px" />
				</td>
				<td>
			...
			<tr>
				<td>
					<img src="http://localhost/roomBooking/bookingSystem/img/event2.png" alt="room" width="480px" height="250px" />
				</td>
				<td>
