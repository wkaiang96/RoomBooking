        ...
        <div class="container" style="margin-top:10%;margin-bottom:5%">
        	<div class="row">
               <div class="col-xs-5 item-photo">
                    <img style="max-width:100%;" src="img/24313176_10155625634820266_8321697187311929618_o.jpg" />
                </div>
                <form action="join.php" method="post">
                <div class="col-xs-5" style="border:0px solid gray">
                    <!-- event details -->
					<h6><input type="hidden" value="NYEP2018" name="eventid"/>NYEP2018</h6>
                    <h3 ><input type="hidden" name="eventName" value="HARD ROCK Penang 31.12.2018"  />HARD ROCK Penang 31.12.2018</h3>    
                    <p >Pool Side New Year Eve Party @ Hard Rock Hotel</p>
					<h5>Fireworks, expect a timetable full of exciting events including snake show, fire show, games and live musics!</h5>
